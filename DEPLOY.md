...
| `FACEBOOK_CALLBACK_URL` | `https://ai-chat-backend.onrender.com/auth/facebook/callback` |
| `FRONTEND_URL` | `https://ai-chat-backend.onrender.com` |
| `AI_SERVICE_URL` | `https://ai-chat-ai-service.onrender.com` |
...
```
https://ai-chat-backend.onrender.com/auth/facebook/callback
```

## Bước 5 — Test

Mở `https://ai-chat-backend.onrender.com` → đăng nhập Facebook
